...
| **request coalescing**  | Core behavior that lets concurrent evaluations with one flag and identity share provider work after resolve hooks. Each evaluation keeps its own error, fallback, and cancellation path.                                 |
