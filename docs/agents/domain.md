...
| **cache**               | Built-in behavior that reads a decision before provider work and writes the leader's decision after commit. The store owns serialization and expiry.                                                                            |
