...
| Term                    | Meaning                                                                                                                                                                                                                  |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **gate factory**        | The callable object returned from `buildGate`. It creates evaluators and owns `snapshot()`; snapshots accept only evaluators from that same factory.                                                                     |
...
| **snapshot**            | The synchronously readable result of evaluating several gates together after one identity resolution and optional `decideMany` provider batch.                                                                           |
