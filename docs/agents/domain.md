...
| **cache**               | Built-in behavior that reads a decision before provider work and writes the decision from the evaluation that called the provider after commit. The store owns serialization and expiry.                                        |
