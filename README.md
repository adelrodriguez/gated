...
- [Evaluate gates](#evaluate-gates)
  ...
  - [Variant gates](#variant-gates)
  - [Evaluation details](#evaluation-details)
  - [Batches](#batches)
- [Supply an identity](#supply-an-identity)
  - [Resolve the identity in the factory](#resolve-the-identity-in-the-factory)
  - [Supply the identity for each call](#supply-the-identity-for-each-call)
  - [Allow anonymous evaluation](#allow-anonymous-evaluation)
- [Configure evaluation](#configure-evaluation)
  - [Set timeouts and cancel evaluations](#set-timeouts-and-cancel-evaluations)
  - [Observe evaluations with hooks](#observe-evaluations-with-hooks)
  - [Cache provider decisions](#cache-provider-decisions)
  - [Invalidate on provider changes](#invalidate-on-provider-changes)
  - [Share concurrent provider work](#share-concurrent-provider-work)
  - [Customize the evaluation key](#customize-the-evaluation-key)
- [Use Gated with React](#use-gated-with-react)
  - [Read a gate in a component](#read-a-gate-in-a-component)
  - [Render a feature conditionally](#render-a-feature-conditionally)
  - [Control the React gate cache](#control-the-react-gate-cache)
