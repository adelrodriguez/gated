...
| 05  | React integration rework                  | H2, H3, H10, arch #4                  | — (03 recommended) | Yes (FeatureGate semantics) |
| 06  | Enrich HookContext                        | API #2                                | 03                 | Yes (drops `TOptions`)      |
| 07  | Evaluation details API                    | H6, API #1                            | 03                 | No (additive)               |
| 08  | Evaluator options object                  | API #3                                | —                  | Yes (call signature)        |
| 09  | Timeout + abort support                   | API #4                                | 08                 | No (additive)               |
| 10  | Decision discriminant + variant payloads  | API #5                                | 03                 | Yes (Decision shape)        |
| 11  | Anonymous identity support                | API #6                                | 03                 | Behavioral                  |
| 12  | Batch evaluation / snapshots              | API #7                                | 03, 08             | No (additive)               |
| 13  | Test & docs hardening                     | Testing #1-#5                         | all prior          | No                          |
...
- 05 is independent of core changes and urgent (React integration currently unusable with real async gates); it can be done in parallel with 03-04.
