...
| 05  | React integration rework                  | H2, H3, H10, arch #4                  | — (coordinate 08) | Yes (FeatureGate semantics) |
...
| 13  | Define hook authoring                     | Class-free hook definitions           | 04, 06, 09, 10    | No (deprecates createHook)  |
...
- 13 adds the preferred hook-authoring interface after the hook context, decision, signal, and error contracts have stabilized. `createHook` remains a deprecated alias until 1.0.
